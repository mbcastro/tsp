...
createImage.rb --clusters tsp_seq_mppa_slave --boot=tsp_seq_mppa_master -T tsp_seq_mppa_image
createImage.rb --clusters tsp_lock_mppa_slave --boot=tsp_lock_mppa_master -T tsp_lock_mppa_image
